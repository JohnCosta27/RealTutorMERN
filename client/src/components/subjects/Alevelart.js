      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            Finding your artistic passion in a subject as broad as Art can be
            difficult, however at Real Tutor we strive to help you find your
            style while also achieving the grade you deserve. We believe in
            individuality, being unique is something to fuel your art - so why
            hide it?
          </Typography>
          <br></br>
          <Typography variant="body2">
            A-Level Art is about presenting you and your style, whatever that
            may be; we will help you explore out of your comfort zone while also
            making sure your artwork is true to you and a representation of what
            you can do. With drawing, painting and digital tips and tricks from
            ex-students who achieved an A or higher at A-Level, you’re
            guaranteed to learn something new for your sketchbooks, and how to
            apply that to impress the exam board. You will also see examples of
            your personal tutor’s sketchbooks, pieces and even final products
            during the course, to inspire and guide you along your own artistic
            journey.
          </Typography>
          <br></br>
          <Typography variant="body2">
            Not only will you impress examiners, but you will also leave Sixth
            Form with a strong and personal portfolio ready for your future
