      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            Physics is often called one of the hardest A-levels, next to Further
            Maths and Chemistry. However, it doesn’t have to be. At Real Tutor,
            we offer physics tutoring that sheds new light upon what can be a
            rather daunting subject. Concepts that often seem counterintuitive
            and backwards can be explained in a multitude of different ways.
            Most students tend to struggle with the concepts and the theory, as
            opposed to the mathematics. Despite this, both will still be covered
            in the necessary detail that fits the needs of the student.
          </Typography>
          <br></br>
          <Typography variant="body2">
            At the end of each session, the student will be given a worked
            example, and exam questions that cover the content in that lesson.
            These will not be answered under exam conditions however. The tutor
            will be there at all times during the session to answer questions.
            Also, depending on how the tutor feels the student is progressing,
            the student may be given surprise questions on previously covered
            topics, as a form of revision. Speaking of which, constant revision
            will be a prime aspect of ensuring a student’s growth in physics.
          </Typography>
          <br></br>
          <br></br>
        </div>
