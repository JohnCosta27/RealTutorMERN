      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            We aim to make you understand computers and the technology world,
            there is a lot of theory involved with this A-level and a lot of
            things that you need to remember, and to do this we will present
            information in an interactive way that actually explains the world
            around you, instead of just sitting you down and lecturing you. We
            will show you how the internet works, how you could create tiny
            networks, develop your own project, and even a sneak peak at the
            code that makes up our systems.
          </Typography>
          <br></br>
          <Typography variant="body2">
            You will undertake your own tiny projects as you learn as well as
            constantly looking at exam questions and looking ahead in the
            specification to know what you need to do next, so you really
