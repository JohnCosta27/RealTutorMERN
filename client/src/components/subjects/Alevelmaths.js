      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            The only way you get better at maths is by doing maths. Our Maths
            lessons are question based, which means as the student learns new
            content we actively show them exam questions with topics they just
            learnt, this way the student can get accustomed to the type of
            questions as well as reinforcing their knowledge.
          </Typography>
          <br></br>
          <Typography variant="body2">
            We also make sure to constantly revise what we have done before,
            this will allow for reinforced learning to come into play which
            means the student will not forgot content, which so very often
            happens in colleges. This is possible due to our custom made
            software which tracks progress and can tell us exactly what the
            student knows.
          </Typography>
          <br></br>
          <br></br>
