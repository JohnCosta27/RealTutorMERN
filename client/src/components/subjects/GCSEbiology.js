      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            GCSE biology is one of the most popular GCSE options and as one of
            the core sciences a good understanding of the subject is important
            when it comes to progressing further in science. It is well known
            that there is a large workload that comes with biology and because
            of this the more exposure to the subject that the student can have
            then the better they will perform.
          </Typography>
          <br></br>
          <Typography variant="body2">
            Throughout the sessions we will go over the content of the course
            focusing on the topics that the student finds more difficult to
            understand. We will also use exam questions and past paper examples
            to consolidate the learning that the student has done and to aid
            with revision.
          </Typography>
          <br></br>
          <br></br>
