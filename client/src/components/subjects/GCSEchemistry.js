      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            While it is possible to remember all of the theory in chemistry, we
            have found that being able to spot patterns in reactions and being
            able to predict what will happen in specific situations is a far
            better way to learn the content in this subject. While learning to
            recognise patterns the student will be able to understand to a
            deeper level why things happen in the way they do and over time they
            will learn to apply the knowledge they have to exam questions.
          </Typography>
          <br></br>
          <Typography variant="body2">
            Constant revision and visiting topics that we have not covered in a
            while during sessions will be the most effective way of ensuring
            that the student will get the best result possible and reach their
            full potential.
          </Typography>
          <br></br>
          <br></br>
