      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            In many ways, GCSE Computer Science is all about the teacher. If you
            have a teacher you don’t quite get along with or whose style of
            teaching doesn’t do you any favours, you won’t like computer
            science. At Real Tutor we make sure you love computer science. There
            are simply too many fascinating things about this subject for a
            student to not enjoy it, so rest assured that you will not only pass
            your exams with flying colours, but you will have a deeper
            appreciation for computers.
          </Typography>
          <br></br>
          <Typography variant="body2">
            We make sure we take a hands on approach, how are you going to learn
            about computers without coding? We will make sure to do tiny
            programs and show you theoretical concepts with a hands on approach,
            aided by our use of digital solutions to enhance tutoring.
          </Typography>
          <br></br>
          <br></br>
        </div>
