      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            Physics can be a very daunting GCSE, and can often appear
            overwhelming. Feel the same? Well you're in the right place. At Real
            Tutor, we offer top notch tuition in order to tackle difficult
            problems. Physics theory that may not seem to make sense at first
            can be explained in different ways by making analogies to what the
            student already knows. Both the theory and the maths will be given
            equal weightings of importance.
          </Typography>
          <br></br>
          <Typography variant="body2">
            At the end of each session, the student will be given worked
            examples, and aided exam questions that cover the content in that
            lesson. Any work not finished in lesson may be assigned as optional
            homework tasks, IE for revision purposes. Also, depending on how the
            tutor feels the student is progressing, the student may be given
            surprise questions on previously covered topics, as a form of
            revision. Comprehending topics and mathematics is only the
            beginning. The true key to scoring higher in your exams (physics
            especially) is revising what we have previously covered.
          </Typography>
          <br></br>
          <br></br>
        </div>
