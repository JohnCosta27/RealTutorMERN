      ...
      >
        <div style={{ maxWidth: 800, justifyContent: "center" }}>
          ...
          <Typography variant="body2">
            A-level Further Maths is in a whole different league to other
            A-levels, in fact it is so sought after that students with it
            achieve on average £5000 more in their salaries compared to their
            peers. It is a subject that needs incredible ability and attention
            and we are here to help you. We take a very similar approach to
            A-level Maths, however we take a more theoretical approach, as much
            of the content is incredibly dense, so understanding what you are
            doing, before attempting questions is extremely important.
          </Typography>
          <br></br>
          <Typography variant="body2">
            We will make sure to constantly look at the A-level as a whole and
            make sure that you know what you have to do for each topic, by
            showing you relevant exam questions and how you will break these
            down to solve the very complex problems that can be presented to
            you.
          </Typography>
          <br></br>
          <br></br>
