      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          <Typography variant="body2">
            A level chemistry is a subject that requires a good understanding of
            many different mathematical principles along with the knowledge
            required for the base content of the subject. In order for a student
            to grasp a subject in chemistry to the level they require it is
            important that they are exposed to questions in a variety of
            different contexts and situations. When it comes to solving problems
            and working through questions confidence and lots of practice is the
            most effective way of ensuring you are as prepared as you can be.
          </Typography>
          <br></br>
          <Typography variant="body2">
            Past paper questions will be used to discover what areas of weakness
            a student has and then these can be focused on. Each lesson will
            have a plan of what we intend to cover but the lessons will not be
            restricted to this, and if questions come up or a student is
            stronger in a certain area than expected then we can cover whatever
            the tutor and student feel would be the most effective topics to
            benefit learning.
          </Typography>
          <br></br>
          <br></br>
