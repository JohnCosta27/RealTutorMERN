      ...
      <Section auto={true} centered={true} background="offwhite" narrow={true}>
        <div>
          ...
          <Typography variant="body2">
            This is the final step in taking your education to the next level,
            after you complete payment, we will arrange the sessions, and make
            sure that you get what you deserve!
          </Typography>
          <br></br>
          <Typography variant="body2">
            This goes without saying but do NOT make a payment if you have not
            spoken to us before, we need to make sure that we can completely
            satisfy your request before we can take payment.
          </Typography>
        </div>
      </Section>
