...
const PrivacyPolicy = () => {
  return (
    <div>
      <DefaultAppBar />
      <Banner small={true} title="Privacy Policy" />
      <Section background="offwhite" auto={true}>
        <div id="md_en" data-target="out_en" class="agreement_md">
          <Box lineHeight={2}>
            <Typography variant="h1">Privacy Policy</Typography>
            <br></br>
            <Typography variant="body2">Last updated: June 06, 2021</Typography>
            ...
            <ul>
              ...
              <li>
                <Typography variant="body2">
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Real Tutor
                  Ltd, Skelmorlie, Gough Road, Fleet, England, GU51 4LJ.
                </Typography>
              </li>
              <li>
                <Typography variant="body2">
              ...
              <li>
                <Typography variant="body2">
                  <strong>Website</strong> refers to Real Tutor, accessible from{" "}
                  <a
                    href="www.realtutor.online"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    www.realtutor.online
                  </a>
                </Typography>
              </li>
              <li>
            ...
            <ul>
              <li>By email: john@realtutor.online</li>
            </ul>
          </Box>
        </div>
        <br></br>
