		...
		<div style={{ overflow: 'hidden' }}>
			...
			<Section medium={true} centered={true}>
				<div className={classes.wrappingText}>
					...
					<br></br>
					<Typography variant="body2">
						You won't just talk to your tutor. You will talk to the
						CEO, COO and other members of staff, about your own
						progress, and ways we could make your life easier. All
						so you can achieve the best grade.
					</Typography>
					<br></br>
					<Typography variant="body2">
						Real Tutor offers you peace of mind. We will never turn
						away a student in need, and we promise to always deliver
						the best quality education. Period.
					</Typography>
					<br></br>
					<br></br>
				</div>
